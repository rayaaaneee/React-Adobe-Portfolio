...
export const Semester = forwardRef(({ semester, key, clickSemester, colorPoint, uncolorPoint, openSemesterPage }, ref) => {

    return (
        <div className="semester animate" initial-x={ (Math.floor(Math.random() * 20) - 10) } ref={ ref } key={ key } onMouseOver={ colorPoint } onClick={ clickSemester } onMouseOut={ uncolorPoint }>
